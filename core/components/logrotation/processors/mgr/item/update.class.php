...
class logRotationItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('logrotation_item_err_ns');
        }
...
return 'logRotationItemUpdateProcessor';
